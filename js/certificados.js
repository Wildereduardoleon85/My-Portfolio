    ...
    let salida2 = `
        <div id="newDiv" class="single">
            ...
            <div class="texto">
                ...
                <div><a href="${certificados[e.target.id].url}" target="_blank">See Credentials in Main Page</a></div>
                <div class="volver"><a id="volver">Back</a></div>
            </div>
        </div>
    `;
